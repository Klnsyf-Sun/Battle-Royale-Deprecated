...
public enum MessageKey {
	...
	// ¡ìr¡ì6Battlefield Book
	BATTLEFIELD_BOOK_DISPLAY_NAME("BATTLEFIELD_BOOK.DISPLAY_NAME"),

	// ¡ìrRight Click to Open Battlefield GUI
	BATTLEFIELD_BOOK_LORE("BATTLEFIELD_BOOK.LORE"),

	// -= Battlefield GUI =-
	BATTLEFIELD_GUI_TITLE("BATTLEFIELD_GUI.TITLE"),

	// Preseted
	BATTLEFIELD_GUI_STATUE_PRESETED("BATTLEFIELD_GUI.STATUE.PRESETED"),

	// Loading
	BATTLEFIELD_GUI_STATUE_LOADING("BATTLEFIELD_GUI.STATUE.LOADING"),

	// Running
	BATTLEFIELD_GUI_STATUE_RUNNING("BATTLEFIELD_GUI.STATUE.RUNNING"),

	// ERROR
	BATTLEFIELD_GUI_STATUE_ERROR("BATTLEFIELD_GUI.STATUE.ERROR"),

	// ¡ìrBattlefield: ¡ìb%WORLDNAME
	BATTLEFIELD_GUI_BATTLEFIELD_ITEM_DISPLAY_NAME("BATTLEFIELD_GUI.BATTLEFIELD_ITEM.DISPLAY_NAME", "%WORLDNAME"),

	// ¡ìrPlayer: ¡ìd%CURRENTPLAYER/%MAXPLAYER
	BATTLEFIELD_GUI_BATTLEFIELD_ITEM_LORE_PLAYER("BATTLEFIELD_GUI.BATTLEFIELD_ITEM.LORE.PLAYER", "%CURRENTPLAYER",
			"%MAXPLAYER"),

	// ¡ìrStatue: ¡ìb%STATUE
	BATTLEFIELD_GUI_BATTLEFIELD_ITEM_LORE_STATUE("BATTLEFIELD_GUI.BATTLEFIELD_ITEM.LORE.STATUE", "%STATUE"),
